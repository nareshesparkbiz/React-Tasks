...
const formhandler=(e)=>{
    ...
    if(formdata.email!="" && formdata.pass!=""){
           ...
           for(let i in userData){
            ...
            if(userData[i].email===formdata.email && userData[i].password===formdata.pass){
              ...
              <div class="row justify-content-center">
                ...
                <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        ...
                        {formerror.email?<span style={{color:'red'}}>*Email not Registered</span>:""}
                      </div>
                    </div>
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        ...
                        {formerror.pass?<span style={{color:'red'}}>*Please Enter Correct password</span>:""}
                      </div>
                    </div>

                    <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                      <button type="submit" class="btn btn-primary btn-lg" onSubmit={(e)=>(formhandler(e))}>Login</button>
                    </div>
